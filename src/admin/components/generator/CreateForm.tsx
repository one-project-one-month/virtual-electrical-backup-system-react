    ...
    <form className='grid grid-cols-12 gap-5 p-4 pl-10 pt-5' >
      <div className="col-span-3 grid gap-2">
       ...
       <div className="col-span-3 grid gap-2">
        ...
        <SelectBrand data={brands}  name="brandId" defaultValue="" />
      ...
      <div className="row-start-2 col-span-3 grid gap-2">
        ...
        <Input type='number' id='watt' placeholder='watt' name='watt'  required/>
      </div>
      <div className="row-start-3 col-span-3 grid gap-2">
        ...
        <Input type='text' id='fuelType' placeholder='fuel type' name='fuelType'  required/>
      </div>
      <div className="row-start-3 col-span-3 grid gap-2">
      ...
      <div className="row-start-5 col-span-6 grid gap-2">
        ...
        <Textarea id='price' placeholder='description' name='description'  required/>
      </div>
